package su.anfiox.core.uikit.components.topbar
...
import su.anifox.core.uikit.generated.resources.core_uikit_component_preview_top_bar
...
private fun PreviewSimpleTopBar() {
    ...
    DefaultPreview {
        SimpleTopBar(
            onBackPressed = { },
            title = stringResource(Res.string.core_uikit_component_preview_top_bar),
            tonalElevation = 4.dp,
