package su.anfiox.core.uikit.components.button
...
import su.anfiox.core.uikit.components.icon.AnifoxIconOnPrimary
import su.anfiox.core.uikit.components.icon.AnifoxIconOnSurface
...
private fun PreviewAnifoxButtonIconTransparent() {
    DefaultPreview {
        AnifoxButtonIconTransparent(
            ...
            AnifoxIconOnSurface(
                imageVector = Outlined.ContentCopy,
                contentDescription = "content description"
            )
        }
    }
