...
@Composable
internal fun CardRelationComponentItemShimmer(
...
@Composable
internal fun ShowCardRelationComponentItemShimmer(
    modifier: Modifier,
    shimmerInstance: Shimmer,
    count: Int = 3,
    ...
    repeat(count) {
        CardRelationComponentItemShimmer(
            modifier = modifier,
...
@PreviewLightDark
@Composable
private fun PreviewRelationComponentItemShimmer() {
    DefaultPreview {
        CardRelationComponentItemShimmer(
            Modifier,
