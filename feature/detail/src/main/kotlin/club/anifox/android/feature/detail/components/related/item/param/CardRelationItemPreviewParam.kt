...
internal data class CardRelationItemPreviewParam(
...
internal class CardRelationItemProvider:
    PreviewParameterProvider<CardRelationItemPreviewParam> {
    override val count: Int
        get() = super.count
    override val values: Sequence<CardRelationItemPreviewParam>
        get() = listOf(
            CardRelationItemPreviewParam(
                Modifier,
            )
        ).asSequence()
}